...
import {
    ...
    IconLanguage, IconBrandFacebook
                        ...
                        <Paper p="md" radius="md" withBorder shadow="sm">
                            {isSmart ? (
                                ...
                                <Select
                                    ...
                                    size="md"
                                    {...form.getInputProps('optimization_goal')}
                                    required
                                />
                            )}
                        </Paper>
                        ...
                        <Paper p="md" radius="md" withBorder shadow="sm">
                            ...
                            <Group justify="space-between" wrap="nowrap">
                                ...
                                <Switch
                                    ...
                                    offLabel="OFF"
                                    color="blue"
                                    checked={form.values.useAdvantageAudience}
                            ...
                            {/* Location Targeting (Always visible) */}
                            ...
                            {!form.values.useAdvantageAudience && !isSmart && (
                                <>
                                    {/* Demographics */}
                                    <Paper p="md" radius="md" withBorder shadow="xs" mt="xl">
                                        <Group mb="md">
                        ...
                        <Paper p="md" radius="md" withBorder shadow="sm">
                            <Group justify="space-between" wrap="nowrap">
                                ...
                                <Switch
                                    ...
                                    color="orange"
                                    disabled={isSmart}
                                    checked={form.values.useAdvantagePlacements}
