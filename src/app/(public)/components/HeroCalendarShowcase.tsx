...
const calendarMonths: CalendarMonth[] = [
  {
    ...
    account: "Roofing lead calendar",
    icon: Wrench,
    year: 2026,
    month: 3,
    entries: [
      { id: "apr-1", day: 2, title: "Spring roof inspection push", time: "All day", kind: "all_day", tone: "bg-orange-500" },
      { id: "apr-2", day: 4, title: "Storm-damage creative refresh", time: "2:10 PM", kind: "timed", tone: "bg-cyan-500" },
      { id: "apr-3", day: 7, title: "Raise quote-request spend", time: "11:30 AM", kind: "timed", tone: "bg-emerald-500" },
      { id: "apr-4", day: 7, title: "Gutter repair follow-up", time: "All day", kind: "all_day", tone: "bg-amber-500" },
      { id: "apr-5", day: 13, title: "Hail-damage revisit push", time: "8:40 AM", kind: "timed", tone: "bg-blue-500" },
      { id: "apr-6", day: 15, title: "Owner estimate brief", time: "3:30 PM", kind: "timed", tone: "bg-fuchsia-500" },
      { id: "apr-7", day: 18, title: "Roofing callback test", time: "10:15 AM", kind: "timed", tone: "bg-emerald-500" },
      { id: "apr-8", day: 22, title: "Refresh quote form headline", time: "12:20 PM", kind: "timed", tone: "bg-amber-500" },
      { id: "apr-9", day: 22, title: "Approve gutter repair upsell", time: "All day", kind: "all_day", tone: "bg-cyan-500" },
      { id: "apr-10", day: 28, title: "Final week spend shift", time: "9:20 AM", kind: "timed", tone: "bg-fuchsia-500" },
      { id: "apr-11", day: 30, title: "Estimate recap", time: "All day", kind: "all_day", tone: "bg-slate-900" },
    ],
  },
  {
    key: "may-2026",
    ...
    account: "Tiling install calendar",
    icon: Wrench,
    year: 2026,
    month: 4,
    entries: [
      { id: "may-1", day: 1, title: "Showroom weekend push", time: "All day", kind: "all_day", tone: "bg-orange-500" },
      { id: "may-2", day: 5, title: "Tile quote retargeting lift", time: "12:10 PM", kind: "timed", tone: "bg-blue-500" },
      { id: "may-3", day: 8, title: "Bathroom remodel reminder", time: "9:35 AM", kind: "timed", tone: "bg-emerald-500" },
      { id: "may-4", day: 12, title: "Swap weak install creative", time: "1:45 PM", kind: "timed", tone: "bg-amber-500" },
      { id: "may-5", day: 12, title: "Backsplash quote reminder", time: "All day", kind: "all_day", tone: "bg-cyan-500" },
      { id: "may-6", day: 19, title: "Kitchen floor upsell test", time: "11:20 AM", kind: "timed", tone: "bg-emerald-500" },
      { id: "may-7", day: 21, title: "Friday install recap", time: "3:30 PM", kind: "timed", tone: "bg-blue-500" },
      { id: "may-8", day: 24, title: "Weekend showroom invite", time: "All day", kind: "all_day", tone: "bg-fuchsia-500" },
      { id: "may-9", day: 24, title: "Kitchen quote callback", time: "1:05 PM", kind: "timed", tone: "bg-amber-500" },
      { id: "may-10", day: 30, title: "Install review", time: "All day", kind: "all_day", tone: "bg-slate-900" },
    ],
  },
  {
    key: "june-2026",
    ...
    account: "Dental consult calendar",
    icon: PhoneCall,
    year: 2026,
    month: 5,
    entries: [
      { id: "jun-1", day: 3, title: "Smile makeover offer update", time: "All day", kind: "all_day", tone: "bg-orange-500" },
      { id: "jun-2", day: 6, title: "Adjust weak consult audience", time: "11:00 AM", kind: "timed", tone: "bg-amber-500" },
      { id: "jun-3", day: 9, title: "Before-and-after creative swap", time: "1:25 PM", kind: "timed", tone: "bg-emerald-500" },
      { id: "jun-4", day: 11, title: "Missed consult reminder", time: "4:05 PM", kind: "timed", tone: "bg-cyan-500" },
      { id: "jun-5", day: 14, title: "Whitening callback prompt", time: "All day", kind: "all_day", tone: "bg-fuchsia-500" },
      { id: "jun-6", day: 17, title: "Refresh implant consult headline", time: "12:15 PM", kind: "timed", tone: "bg-emerald-500" },
      { id: "jun-7", day: 20, title: "Friday consult recap", time: "3:10 PM", kind: "timed", tone: "bg-blue-500" },
      { id: "jun-8", day: 23, title: "Missed-call follow-up test", time: "9:50 AM", kind: "timed", tone: "bg-amber-500" },
      { id: "jun-9", day: 23, title: "Whitening consult reminder", time: "All day", kind: "all_day", tone: "bg-fuchsia-500" },
      { id: "jun-10", day: 29, title: "Consult review", time: "All day", kind: "all_day", tone: "bg-slate-900" },
    ],
  },
];
