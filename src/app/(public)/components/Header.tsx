        ...
        <header className="sticky top-0 z-40 border-b border-blue-100/80 bg-white/90 shadow-[0_10px_34px_rgba(15,23,42,0.07)] backdrop-blur-xl">
            <Container className="flex items-center justify-between py-4">
                <Link href="/" className="flex items-center gap-2 text-slate-950">
                    <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-700 text-xs font-semibold text-white shadow-[0_12px_26px_rgba(37,99,235,0.18)]">
                        DV
                    </span>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        size="sm"
                        variant="primary"
                        className="bg-blue-700 text-white shadow-[0_14px_32px_rgba(37,99,235,0.2)]"
                    >
